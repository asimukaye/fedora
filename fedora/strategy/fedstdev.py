...
def gradient_update_per_param(server_params: fT.ActorParams_t,client_params: fT.ClientParams_t,
    weights: ClientScalarWeights_t) -> tuple[fT.ActorParams_t, fT.ActorDeltas_t]:
...
class FedstdevStrategy(ABCStrategy):
    ...
    @classmethod
    def client_send_strategy(cls, ins: FedstdevInsProtocol, result: fT.Result) -> fT.ClientResult:
    ...
    @classmethod
    def _compute_sigma_by_mu(cls, sigmas: fT.ActorParams_t, mus: fT.ActorParams_t) -> fT.ActorParams_t:
